...
Para essa parte, foi inicializado no Boot da Raspberry Pi pelo systemd um programa, também intitulado de serviço, em python chamado **blink.py** , um programa já desenvolvido em uma prática anterior que consiste em acionar um LED ao pressionar um botão. 
